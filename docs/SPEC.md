...
| Item                                          | Status                            |
| --------------------------------------------- | --------------------------------- |
| OTP / SMS provider                            | **To be chosen** before launch    |
| API error contract appendix                   | **Pending** before implementation |
...
- **Database:** PostgreSQL, hosted on **Railway** (managed Postgres service).
